...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('medicalimageviewer/showrecentactivity', get_string('showrecentactivity', 'medicalimageviewer'),
                                                  get_string('showrecentactivity', 'medicalimageviewer'), 0,
                                                  array('0' => get_string('no'), '1' => get_string('yes'))));

    $settings->add(new admin_setting_configselect('medicalimageviewer/overview', get_string('showoverview', 'medicalimageviewer'),
